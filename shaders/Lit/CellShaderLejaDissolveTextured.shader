Shader "Lejashaderi/CellShaderLejaDissolveTextured"
{
	Properties
	{
		...
		SubShader
		{
			...
			/*	
				...
				fixed4 frag(v2f i) : SV_Target
				{
					...
					fixed4 DissColor = tex2D(_DissolveTex, i.uv);
					...
					fixed4 Col2 = tex2D(_DissolveTex, i.uv);
					...
					return col*half4(lighting,0)* Col2;
				}
				ENDCG
			}
